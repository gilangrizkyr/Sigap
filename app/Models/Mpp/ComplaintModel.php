...
/**
 * Model complaint khusus MPP (location_id = 2).
 */
class ComplaintModel extends Model
{
    ...
    protected $validationRules = [
        ...
        'service_unit_id'   => 'required|integer', // MPP: service_unit wajib dipilih
    ...
    /**
     * Override findAll — selalu filter ke lokasi MPP (location_id = 2).
     */
