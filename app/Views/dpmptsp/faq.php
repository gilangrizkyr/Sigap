...
<div style="text-align: center; max-width: 800px; margin: 0 auto 20px;">
    <h1 style="font-size: 36px; font-weight: 800; line-height: 1.25; margin-bottom: 10px; color: #ffffff;">
        FAQ — Portal Pengaduan DPMPTSP
    </h1>
    <p style="color: rgba(255,255,255,0.9); font-size: 16px; margin-bottom: 0; line-height: 1.6;">
        Pertanyaan yang sering diajukan seputar cara menggunakan portal Sigap untuk DPMPTSP.
    </p>
</div>
...
<div class="card" style="padding: 32px; color: #111827; max-width: 800px; margin: 0 auto 30px; box-shadow: 0 20px 40px rgba(0,0,0,0.15);">
    <?php $faqs = [
        [
            'q' => 'Apa saja jenis laporan yang bisa dikirim melalui portal ini?',
            'a' => 'Tersedia empat jenis laporan: <strong>Pengaduan</strong> (keluhan layanan tidak memuaskan), <strong>Aspirasi</strong> (saran perbaikan), <strong>Apresiasi</strong> (pujian atas layanan yang baik), dan <strong>Saran</strong> (masukan umum untuk DPMPTSP).'
        ],
        [
            'q' => 'Apakah saya wajib mengisi nama dan data diri saat melapor?',
            'a' => 'Tidak wajib. Aktifkan toggle <strong>"Lapor Secara Anonim"</strong> di bagian atas formulir. Kolom nama, WhatsApp, dan email akan otomatis tersembunyi dan tidak ada data identitas Anda yang tersimpan di sistem.'
        ],
        [
            'q' => 'Bagaimana cara melacak status laporan setelah dikirim?',
            'a' => 'Setiap laporan menghasilkan <strong>Nomor Tiket</strong> dan <strong>PIN Rahasia</strong>. Simpan keduanya, lalu kunjungi menu <strong>Lacak Aduan</strong> untuk memantau progres dan membaca tanggapan resmi petugas DPMPTSP.'
        ],
        [
            'q' => 'Berapa lama laporan akan ditanggapi oleh petugas?',
            'a' => 'Laporan mulai diproses dalam <strong>1×24 jam hari kerja</strong>. Status perkembangan dapat dipantau secara real-time melalui fitur Lacak Aduan menggunakan nomor tiket dan PIN.'
        ],
        [
            'q' => 'Bisakah saya melampirkan bukti foto atau dokumen PDF?',
            'a' => 'Ya. Di bagian akhir formulir tersedia kolom <strong>Upload Lampiran Bukti</strong> yang mendukung format JPG, PNG, dan PDF dengan ukuran maksimal <strong>5 MB</strong>. Melampirkan bukti sangat dianjurkan agar laporan diproses lebih cepat.'
        ],
        [
...
<div style="text-align:center; margin-bottom: 20px;">
    <a href="<?= base_url('dpmptsp') ?>" style="display:inline-flex; align-items:center; gap:8px; background:rgba(255,255,255,0.15); border:1.5px solid rgba(255,255,255,0.4); color:#ffffff; padding:11px 26px; border-radius:30px; text-decoration:none; font-weight:700; font-size:14px; backdrop-filter:blur(8px); transition:all 0.3s ease;">
        <i class="fa-solid fa-paper-plane"></i> Kirim Laporan ke DPMPTSP
    </a>
</div>
