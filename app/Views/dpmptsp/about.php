...
<div style="text-align: center; max-width: 800px; margin: 0 auto 20px;">
    <h1 style="font-size: 36px; font-weight: 800; line-height: 1.25; margin-bottom: 10px; color: #ffffff;">
        Tentang Portal — DPMPTSP
    </h1>
    <p style="color: rgba(255,255,255,0.9); font-size: 16px; margin-bottom: 0; line-height: 1.6;">
        Kenali Sigap sebagai saluran pengaduan resmi untuk layanan DPMPTSP.
    </p>
</div>
...
<div class="card" style="padding: 32px; color: #111827; max-width: 800px; margin: 0 auto 30px; box-shadow: 0 20px 40px rgba(0,0,0,0.15);">
    ...
    <div style="margin-bottom: 28px; padding-bottom: 28px; border-bottom: 1px solid #f3f4f6;">
        ...
        <p style="font-size: 14.5px; color: #4b5563; line-height: 1.7; margin: 0;">
            <strong style="color:#111827;">Sigap</strong> adalah portal pengaduan publik berbasis web yang menjadi jembatan resmi antara masyarakat dan layanan <strong style="color:#111827;">DPMPTSP</strong>. Setiap keluhan, aspirasi, maupun apresiasi terkait proses perizinan dapat disampaikan secara langsung, terdokumentasi, dan dilacak secara transparan — tanpa perlu antre di kantor.
        </p>
    </div>
    ...
    <div style="margin-bottom: 28px; padding-bottom: 28px; border-bottom: 1px solid #f3f4f6;">
        ...
        <div class="about-features-grid">
            <?php $features = [
                ...
                ['icon'=>'fa-tags','title'=>'4 Jenis Laporan','desc'=>'Pengaduan, Aspirasi, Saran, atau Apresiasi — pilih yang sesuai kebutuhan Anda.'],
                ['icon'=>'fa-shield-halved','title'=>'Data Terenkripsi','desc'=>'Laporan hanya bisa diakses dengan kombinasi tiket + PIN milik Anda sendiri.'],
            ]; ?>
    ...
    <div>
        <h2 style="font-size: 17px; font-weight: 800; color: #b71c1c; margin-bottom: 16px;">
            <i class="fa-solid fa-list-check" style="margin-right: 8px;"></i>Cara Kerja Portal
        </h2>
        <div style="display: flex; flex-direction: column; gap: 14px;">
            <?php $steps = [
                ['n'=>'1','t'=>'Isi Formulir','d'=>'Pilih jenis laporan, isi judul dan kronologi secara lengkap. Lampirkan bukti jika ada.'],
                ['n'=>'2','t'=>'Kirim — Tiket & PIN Terbit','d'=>'Laporan masuk ke sistem dan menghasilkan Nomor Tiket serta PIN rahasia secara otomatis.'],
                ['n'=>'3','t'=>'Petugas DPMPTSP Memproses','d'=>'Petugas yang berwenang menerima dan menindaklanjuti laporan sesuai kategorinya.'],
                ['n'=>'4','t'=>'Pantau via Lacak Aduan','d'=>'Gunakan tiket & PIN di halaman Lacak Aduan untuk memantau progres dan tanggapan resmi.'],
            ]; ?>
...
<div style="text-align:center; margin-bottom: 20px;">
    <a href="<?= base_url('dpmptsp') ?>" style="display:inline-flex; align-items:center; gap:8px; background:rgba(255,255,255,0.15); border:1.5px solid rgba(255,255,255,0.4); color:#ffffff; padding:11px 26px; border-radius:30px; text-decoration:none; font-weight:700; font-size:14px; backdrop-filter:blur(8px); transition:all 0.3s ease;">
        <i class="fa-solid fa-paper-plane"></i> Mulai Kirim Laporan
    </a>
</div>
...
echo view('layouts/dpmptsp', [
    'page_title'   => 'Tentang Portal DPMPTSP — Sigap',
