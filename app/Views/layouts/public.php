...
<body>
    ...
    <div class="navbar-wrapper" id="stickyNavbar">
        <div class="container">
            <nav class="navbar">
                <a href="<?= base_url('/#hero') ?>" class="nav-logo">
                ...
                <ul class="nav-links" id="navLinks">
                    <li><a href="<?= base_url('/#hero') ?>" class="nav-link">Beranda</a></li>
                    <li><a href="<?= base_url('/#tentang') ?>" class="nav-link">Tentang</a></li>
                    <li><a href="<?= base_url('/#keunggulan') ?>" class="nav-link">Keunggulan</a></li>
                    <li><a href="<?= base_url('/#cara-kerja') ?>" class="nav-link">Cara Kerja</a></li>
                    <li><a href="<?= base_url('/#visi-nilai') ?>" class="nav-link">Visi & Nilai</a></li>
                </ul>
            </nav>
        </div>
    </div>

    <!-- Red Hero Banner (acting as #hero) -->
    <div id="hero" style="position: relative; background: linear-gradient(135deg, #b71c1c 0%, #7f0000 100%); padding: 80px 0 70px; color: #ffffff; box-shadow: inset 0 -10px 20px rgba(0,0,0,0.05); overflow: hidden;">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const navbarWrapper = document.getElementById('stickyNavbar');
        ...
        // Active Navigation Scrollspy (using IntersectionObserver)
        const sections = document.querySelectorAll('#hero, #tentang, #keunggulan, #cara-kerja, #visi-nilai');
        const navLinks = document.querySelectorAll('.navbar-wrapper .nav-link');

        if (sections.length > 0 && navLinks.length > 0) {
            const observerOptions = {
                root: null,
                rootMargin: '-30% 0px -50% 0px', // Trigger when section occupies active center zone
                threshold: 0
            };
            ...
            <div class="footer-grid">
                ...
                <div>
                    ...
                    <ul class="footer-links">
                        <li><a href="<?= base_url('/#hero') ?>"><i class="fa-solid fa-chevron-right"></i>Beranda</a></li>
                        <li><a href="<?= base_url('/#tentang') ?>"><i class="fa-solid fa-chevron-right"></i>Tentang</a></li>
                        <li><a href="<?= base_url('/#keunggulan') ?>"><i class="fa-solid fa-chevron-right"></i>Keunggulan</a></li>
                        <li><a href="<?= base_url('/#cara-kerja') ?>"><i class="fa-solid fa-chevron-right"></i>Cara Kerja</a></li>
                        <li><a href="<?= base_url('/#visi-nilai') ?>"><i class="fa-solid fa-chevron-right"></i>Visi & Nilai</a></li>
                    </ul>
                </div>
                <div>
